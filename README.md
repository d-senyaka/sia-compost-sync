...
| **HTML Command Center (GitHub Pages)** | A real-time web dashboard (`docs/index.html`) for data visualization, state monitoring, and remote hardware intervention. |
...
3.  For the dashboard, open `docs/index.html` locally or deploy it with GitHub Pages:
...
- **Dashboard:** `docs/index.html` (Static MQTT web UI for GitHub Pages).
